...
- 과대적합(overfitting) : 너무 핏하게 짜여진 것을 의미하고, 분산이 크다고 합니다. 핏하면 좋은 것이 아닌가 하겠지만 새로운 데이터로 다시 학습을 시켰을 때 잘 안맞을 확률이 있습니다.

- 과소적합(underfitting) : 모델이 충분히 복잡하지 않는 것입니다. 너무 느슨하게 짜여진 것을 의미합니다.
